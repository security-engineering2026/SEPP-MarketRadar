...
CREATE TABLE IF NOT EXISTS evidence(id INTEGER PRIMARY KEY,opportunity_id INTEGER,observation_id INTEGER,kind TEXT,source TEXT,url TEXT,finding TEXT,confidence REAL,provenance_root TEXT,observed_at TEXT,evidence_hash TEXT UNIQUE);
...
def connect(path):
    ...
    try:
        ...
        _ensure_column(c,'evidence','observation_id','INTEGER')
